...
//   const { position } = visibilityStore.store();

//   const webPageContent = useRef("");
//   const selectedText = useRef<string>("");
//   const selectionState = useRef<"none" | "selection">("none");
...
//     return { selection, text, rect, element };
//   };

//   const handleOnMouseUp = (e: MouseEvent) => {
//     const details = getSelectionDetails();
//     if (!details || !buttonContainerRef.current) {
//       return;
//     }

//     const { selection, text, element } = details;

//     // skip if the selected is in the extension container
...
//     console.log(e);
//     // ensure click is outside of the extension
//     // const clickedTarget = e.target as Node;
//     // if (isInsideExtension(clickedTarget)) return;
//     // if (selectionState.current === "none") {
//     // 	setShowInfoIcon(false);
//     // } else {
//     // 	selectionState.current = "none";
//     // }
//     // setTimeout(() => {
//     // 	const clickedTarget = e.target as Node;
//     // 	if (isInsideExtension(clickedTarget)) return;
